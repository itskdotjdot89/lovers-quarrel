...
const Home = () => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-game flex flex-col overflow-hidden">
      {/* Background effects */}
      ...
      <div className="relative max-w-2xl mx-auto w-full flex-1 flex flex-col min-h-0 px-4" style={{ paddingTop: 'env(safe-area-inset-top)', paddingBottom: 'env(safe-area-inset-bottom)' }}>
        {/* Header */}
