      ...
      case 'say_sip_strip':
        return <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              label,
              icon
            }) => <Button key={label} onClick={() => onChoice?.(label)} variant="outline" className="h-20 flex-col gap-1 text-sm font-card border-2 border-crimson-vivid/50 hover:border-crimson-glow hover:bg-crimson-vivid/10 text-foreground transition-all duration-300 group">
